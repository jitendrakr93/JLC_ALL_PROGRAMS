...
<html><body><h1>Java Learning Center</h1>
<table border="2" style="font-size:26;color:red;">
<tr><td>1)Strings, Wrappers and Date.</td>
<td><c:out value="${requestScope.EM}"/>
<br/>${sessionScope.PH}
<br/>${applicationScope.DOB}<br/></td></tr>

<tr><td>2)Collection of Strings, Wrappers and Date.</td>
<td><table bgcolor="#3d599" style="font-size:26;color:red;">
...
<tr><td>3)Collection of Collections</td>
<td><table bgcolor="#3d599" style="font-size:26;color:red;">
...
</tr></c:forEach></table></td></tr>

<tr><td>4)Custom or User defined class object</td>
<td>Cid : ${CUST.cid}<br/>
...
<tr><td>5)Collection of User defined class object</td>
<td>
<table bgcolor="wheet" style="font-size:26;color:red;">
<tr><td>Cid</td><td>Cname
</td><td>Email</td><td>Phone</td>
<td>Accno</td><td>Atype</td><td>Bal
</td><td>Street</td><td>City</td>
</tr><c:forEach var="cust" items="${sessionScope.CS}">
<tr><td>${cust.cid}</td>
<td>${cust.cname}</td>
<td>${cust.email}</td>
<td>${cust.phone}</td>
...
<td>${cust.account.address.city}</td></tr>
</c:forEach>
</table></td></tr>
...
<tr><td><table bgcolor="#c3d599" style="font-size:26;color:red;">
