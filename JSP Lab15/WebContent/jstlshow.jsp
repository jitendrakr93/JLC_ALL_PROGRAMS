...
${sessionScope.STR[3]}<br/></td></tr>

<tr><td>3)Collection of Collections (*JSTL)</td>
<td>coming soon</td></tr>

<tr><td>4)Customor User defined class object</td>
<td>Cid : ${CUST.cid}<br/>
...
City : ${sessionScope.CUST.account.address.city}<br/></td></tr>
...
City: ${sessionScope.CS[0].account.address.city}<br/></td></tr>

<tr><td>6)Map object</td>
<td>Sid : ${sessionScope.HM["sid"]}<br/>
Sname : ${sessionScope.HM["sname"]}<br/>
Email : ${sessionScope.HM["email"]}<br/></td></tr>

<tr><td>7)Collection of Map object(*JSTL)</td>
<td>coming soon</td></tr>
</table></body></html>